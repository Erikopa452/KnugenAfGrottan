 ...
 * @author erikkarlsson
 */
public class Knugen_GUI_JFrame extends javax.swing.JFrame {

    /**
     * Creates new form Knugen_GUI_JFrame
     */
    public Knugen_GUI_JFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Knugen_GUI_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Knugen_GUI_JFrame().setVisible(true);
            }
        });
    }
